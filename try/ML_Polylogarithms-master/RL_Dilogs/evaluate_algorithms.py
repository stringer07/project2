...
if __name__ == '__main__':
    ...
    start_set = '/home/stringer/Downloads/rl_data_dilogs/test_data.txt'
    ...
    # Load the model
    rl_model = TRPO.load("/home/stringer/Downloads/RL_agents_all/RL Agents/GNN_cyclic_penalty.zip")
